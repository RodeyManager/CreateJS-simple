...
function createLoading(){
	...
	var loadBar = new CJS.Shape(new CJS.Graphics().beginFill('rgba(255, 255, 255, .8)').drawRect(0, loadingField.y - 20 , cw, 3));
	loadMc.addChild(loadingField, loadBar);
